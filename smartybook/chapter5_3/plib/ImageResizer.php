...
class ImageResizer
{
    ...
    public static function image_resize($i_src_path, $i_dst_path, $i_maxW = 640, $i_maxH = 640, $i_quality = 75)
    {
        ...
        $scaleType = self::get_scale_type($srcW, $srcH, $i_maxW, $i_maxH);
        list($dstW, $dstH) = self::scale($scaleType, $srcW, $srcH, $i_maxW, $i_maxH);

        $src_im = self::image_from_file($i_src_path);
        if ($src_im == null) {
            return false;
        }
     ...
     * @return \GdImage|null
     */
    public static function image_from_file($i_src_path): \GdImage|null|false
    {
