 ...
 */
function get_menu_arr(array $i_categories): array
{
    $menu_arr = [];
 ...
 */
function get_featured_arr(string $i_csv): array
{
    $cms_arr = [];
 ...
 * @return string
 */
function get_contents_url(string $i_category): string
{
 ...
 * @return string
 */
function get_image_url(string $i_image): string
{
